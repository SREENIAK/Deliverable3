...
public class Card extends JPanel
{
    ...
    private final JButton playCardBtn = new JButton("Play Card");
    private final JLabel unoLbl = new JLabel();
    private final JLabel cardLbl2 = new JLabel();
    private final JLabel cardLbl1 = new JLabel();
    ...
    /**
     * @return true if this card matches last played card's color, false otherwise
     */
