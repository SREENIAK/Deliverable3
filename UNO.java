...
public class UNO
{
    ...
    private static final Stack<Card> playedCards = new Stack<>();
    private static final JPanel board = new JPanel(new BorderLayout());
    private static final JPanel boardCentre = new JPanel(new BorderLayout());
    private static final JFrame frame = new JFrame("UNO Card Game | OFFLINE");
    private static final JPanel playedCardSection = new JPanel(new BorderLayout());
    ...
    private static void createBoardGFX()
    {
        ...
        /*
          board title
         */
        JLabel title = new JLabel("UNO Card Game");
